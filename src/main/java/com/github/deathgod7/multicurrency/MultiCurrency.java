package com.github.deathgod7.multicurrency;

import com.github.deathgod7.multicurrency.commands.CommandHandler;
import com.github.deathgod7.multicurrency.configs.CurrencyConfig;
import com.github.deathgod7.multicurrency.configs.MainConfig;
import com.github.deathgod7.multicurrency.data.DatabaseManager;
import com.github.deathgod7.multicurrency.depends.economy.CurrencyTypeManager;
...
import com.github.deathgod7.multicurrency.events.EventHandlers;
import com.github.deathgod7.multicurrency.utils.ConfigHelper;
...
public final class MultiCurrency extends JavaPlugin {
	...
	public void onEnable() {
		...
		if (this.getClassLoader() == this.getClass().getClassLoader()) {
			getLogger().info("True it does");
		}
